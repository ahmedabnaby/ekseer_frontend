...
export function LeaveScreen({ setIsMeetingLeft }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if(document.querySelector('textarea[name="message"]') === null){
      message = "";
    }
    else{
    ...
    if(state.loggedInUser.is_doctor){
      doctor_id = state.loggedInUser.id
      patient_id = 0
    }
    else{
      doctor_id = 0
      patient_id = state.loggedInUser.id
    }
  ...
  return (
    <div className="inset-mt bg-gray-800 h-screen flex flex-col flex-1 items-center justify-center">
      <h1 className="text-white text-4xl" style={{ marginBottom: "5px" }}>
        Thanks!
      </h1>
      <h3 style={{ textAlign: 'center', color: '#953e92', marginBottom: '10px' }}>Your Consultation has ended
        How would you rate your consultation?</h3>
        ...
        <div className="rating-container">
          <div className="feedback">
            <div className="rating">
              ...
              <div className="rating-emoji-wrapper">
              ...
              <textarea name='message' placeholder='Share your feedback with us (Optional)'></textarea>
          </div>
        </div>
